...
public class DeepSeekApiService {
    ...
    private String strategyCodeTemplate = "{\n" +
            ...
            "  \"strategyCode\": " +
            "       \"public class GeneratedRsiStrategy extends org.ta4j.core.BaseStrategy {\n" +
            "           \n" +
            "           public GeneratedRsiStrategy(org.ta4j.core.BarSeries series) {\n" +
            "               super(\n" +
            "                   new org.ta4j.core.rules.UnderIndicatorRule(\n" +
            "                       new org.ta4j.core.indicators.RSIIndicator(\n" +
            "                           new org.ta4j.core.indicators.helpers.ClosePriceIndicator(series), 14\n" +
            "                       ), \n" +
            "                       series.numOf(30)\n" +
            "                   ),\n" +
            "                   new org.ta4j.core.rules.OverIndicatorRule(\n" +
            "                       new org.ta4j.core.indicators.RSIIndicator(\n" +
            "                           new org.ta4j.core.indicators.helpers.ClosePriceIndicator(series), 14\n" +
            "                       ), \n" +
            "                       series.numOf(70)\n" +
